...
public class VistaAdmModUser {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VistaAdmModUser window = new VistaAdmModUser();
	...
	private void initialize() {
        ...
        JLabel lbl_productos = new JLabel("Modificar a un usuario");
        ...
        JLabel lbl_productos_1 = new JLabel("Inserte el ID del usuario a modificar");
        ...
        btn_crear = new JButton("Modificar Usuario");
        ...
        btn_crear.setBounds(550, 635, 483, 74);
